...
class RobotGroup implements IRobot, Iterable<IRobot> {
    ...
    public void addRobotObserver(IRobotObserver observer) {
        throw new UnsupportedOperationException("robot.RobotGroup не поддерживает добавление наблюдателей");
    }

    @Override
    public void removeRobotObserver(IRobotObserver observer) {
        throw new UnsupportedOperationException("robot.RobotGroup не поддерживает удаление наблюдателей");
    }
    ...
    @Override
    public MapSegment getCurrentSegment() {
        return null;
    }
