package components.knowledge;

import core.IKnowledgeBase;
import core.ITool;
import models.ToolType;

import java.util.*;
//База знаний для полива
public class WateringKnowledgeBase implements IKnowledgeBase<WateringEntry> {

    //Хранилище данных: ключ - название растения, значение - запись components.knowledge.WateringEntry
