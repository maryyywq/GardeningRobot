...
public class WateringEntry implements IEntry {
    ...
    public WateringEntry(WateringEntry other) { this.volume = other.volume; this.mode = other.mode; }
    public double getVolume() { return volume; }
    public String getMode() { return mode; }
    @Override public String getInfo() {
        return String.format("Полив: объем %.1f л, режим %s", volume, mode);
    }
    @Override public WateringEntry clone() { return new WateringEntry(this); }
}
